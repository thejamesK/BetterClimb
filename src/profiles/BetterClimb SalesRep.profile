...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>BetterClimb</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <classAccesses>
        <apexClass>BC_AccountDivisionSearchController</apexClass>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Lead.Survey_Taken__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>SurveyTaker__c.ContactText__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>SurveyTaker__c.Survey_Question_Response__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <pageAccesses>
        <apexPage>BC_LeadContactForm</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>BC_LeadContactFormThankYou</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
